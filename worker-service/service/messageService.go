...
func getCodeMessage(msg amqp.Delivery) (*model.Task, error) {
	var codeMessage model.Task
...
func (svc *MessageService) SaveResult(ctx context.Context, result model.ExecutionResult) error {
